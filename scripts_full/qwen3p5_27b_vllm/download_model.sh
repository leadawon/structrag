...
usage() {
    cat <<EOF
Usage:
  bash scripts_full/qwen3p5_27b_vllm/download_model.sh
  bash scripts_full/qwen3p5_27b_vllm/download_model.sh --dry-run
...
Examples:
  bash scripts_full/qwen3p5_27b_vllm/download_model.sh
  HF_TOKEN=hf_xxx bash scripts_full/qwen3p5_27b_vllm/download_model.sh
  MODEL_DIR=/workspace/StructRAG/model/Qwen3.5-27B bash scripts_full/qwen3p5_27b_vllm/download_model.sh
  MODEL_ID=Qwen/Qwen3.5-27B REVISION=main bash scripts_full/qwen3p5_27b_vllm/download_model.sh
EOF
}
...
echo "  bash scripts_full/qwen3p5_27b_vllm/run_inference_full.sh"
