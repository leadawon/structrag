...
Usage:
  ...
  bash scripts/72b/download_model.sh --dry-run

Downloads the Qwen2-72B-Instruct Hugging Face model into StructRAG's model directory.
...
echo "  bash scripts/72b/run_inference_full.sh"
